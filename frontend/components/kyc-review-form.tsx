    ...
    <div className={wide ? "sm:col-span-2" : ""}>
      ...
      {initialValue.length > 80 || initialValue.includes("\n") ? (
        <Textarea
          ...
          rows={3}
          className="mt-1 rounded-lg border-gray-200 bg-white focus:border-teal focus:ring-teal/15"
        />
      ) : (
        <Input
          value={val}
...
export const KycReviewForm = forwardRef<KycReviewFormHandle, KycReviewFormProps>(
  function KycReviewForm({ data }, ref) {
      ...
      <Tabs defaultValue="societarios" className="w-full">
        ...
        <TabsContent value="societarios" className="mt-0 rounded-b-[10px] border border-t-0 border-gray-200 bg-white p-5">
          <div className="grid gap-4 sm:grid-cols-2">
            <Field label="Denominación social *" initialValue={_g(ds, "denominacion_actual")} path="datos_societarios.denominacion_actual" onFieldChange={handleFieldChange} />
            <Field label="NIF / CIF *" initialValue={_g(ds, "nif")} path="datos_societarios.nif" onFieldChange={handleFieldChange} />
            <Field label="Forma jurídica" initialValue={_g(ds, "forma_juridica")} path="datos_societarios.forma_juridica" onFieldChange={handleFieldChange} />
            <Field label="CNAE" initialValue={_g(ds, "cnae")} path="datos_societarios.cnae" onFieldChange={handleFieldChange} />
          </div>
          <p className="mt-4 mb-2 text-sm font-semibold text-navy">Domicilio social</p>
          <div className="grid gap-4 sm:grid-cols-[3fr_1fr]">
            <Field label="Calle y número" initialValue={_g(dom, "calle")} path="datos_societarios.domicilio_social.calle" onFieldChange={handleFieldChange} />
            <Field label="Código postal" initialValue={_g(dom, "codigo_postal")} path="datos_societarios.domicilio_social.codigo_postal" onFieldChange={handleFieldChange} />
          </div>
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            <Field label="Localidad" initialValue={_g(dom, "localidad")} path="datos_societarios.domicilio_social.localidad" onFieldChange={handleFieldChange} />
            <Field label="Provincia" initialValue={_g(dom, "provincia")} path="datos_societarios.domicilio_social.provincia" onFieldChange={handleFieldChange} />
          </div>
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            <Field label="Objeto social" initialValue={_g(ds, "objeto_social")} path="datos_societarios.objeto_social" onFieldChange={handleFieldChange} wide />
            <Field label="Duración" initialValue={_g(ds, "duracion")} path="datos_societarios.duracion" onFieldChange={handleFieldChange} />
            <Field
        ...
        <TabsContent value="constitucion" className="mt-0 rounded-b-[10px] border border-t-0 border-gray-200 bg-white p-5">
          <div className="grid gap-4 sm:grid-cols-2">
            <Field label="Notario" initialValue={_g(dc, "notario")} path="datos_constitucion.notario" onFieldChange={handleFieldChange} />
            <Field label="Localidad del notario" initialValue={_g(dc, "localidad_notario")} path="datos_constitucion.localidad_notario" onFieldChange={handleFieldChange} />
            <Field label="Fecha de constitución" initialValue={_g(dc, "fecha")} path="datos_constitucion.fecha" onFieldChange={handleFieldChange} />
            <Field label="Número de protocolo" initialValue={_g(dc, "numero_protocolo")} path="datos_constitucion.numero_protocolo" onFieldChange={handleFieldChange} />
          </div>
        </TabsContent>
        ...
        <TabsContent value="capital" className="mt-0 rounded-b-[10px] border border-t-0 border-gray-200 bg-white p-5">
          <div className="grid gap-4 sm:grid-cols-2">
            <Field label="Importe del capital social" initialValue={_g(cs, "importe")} path="capital_social.importe" onFieldChange={handleFieldChange} />
            <Field label="Moneda" initialValue={_g(cs, "moneda")} path="capital_social.moneda" onFieldChange={handleFieldChange} />
            <Field label="Número de participaciones" initialValue={_g(cs, "num_participaciones")} path="capital_social.num_participaciones" onFieldChange={handleFieldChange} />
            <Field label="Valor nominal unitario" initialValue={_g(cs, "valor_nominal_unitario")} path="capital_social.valor_nominal_unitario" onFieldChange={handleFieldChange} />
          </div>
        </TabsContent>
        ...
        <TabsContent value="registrales" className="mt-0 rounded-b-[10px] border border-t-0 border-gray-200 bg-white p-5">
          <div className="grid gap-4 sm:grid-cols-2">
            <Field label="Registro Mercantil" initialValue={_g(dr, "registro_mercantil")} path="datos_registrales.registro_mercantil" onFieldChange={handleFieldChange} />
            <Field label="Tomo" initialValue={_g(dr, "tomo")} path="datos_registrales.tomo" onFieldChange={handleFieldChange} />
          </div>
          <div className="mt-4 grid gap-4 sm:grid-cols-3">
            <Field label="Folio" initialValue={_g(dr, "folio")} path="datos_registrales.folio" onFieldChange={handleFieldChange} />
            <Field label="Hoja" initialValue={_g(dr, "hoja")} path="datos_registrales.hoja" onFieldChange={handleFieldChange} />
            <Field label="Inscripción" initialValue={_g(dr, "inscripcion")} path="datos_registrales.inscripcion" onFieldChange={handleFieldChange} />
          </div>
        </TabsContent>
        ...
        <TabsContent value="organo" className="mt-0 rounded-b-[10px] border border-t-0 border-gray-200 bg-white p-5">
          <Field label="Tipo de órgano" initialValue={_g(oa, "tipo")} path="organo_administracion.tipo" onFieldChange={handleFieldChange} />
          <div className="mt-4">
        ...
        <TabsContent value="representante" className="mt-0 rounded-b-[10px] border border-t-0 border-gray-200 bg-white p-5">
          <div className="grid gap-4 sm:grid-cols-2">
            <Field label="Nombre completo *" initialValue={_g(rl, "nombre_completo")} path="representante_legal_firmante.nombre_completo" onFieldChange={handleFieldChange} />
            <Field label="DNI / NIE *" initialValue={_g(rl, "dni")} path="representante_legal_firmante.dni" onFieldChange={handleFieldChange} />
            <Field label="Cargo en la sociedad" initialValue={_g(rl, "cargo_en_sociedad")} path="representante_legal_firmante.cargo_en_sociedad" onFieldChange={handleFieldChange} />
            <Field label="Domicilio" initialValue={_g(rl, "domicilio")} path="representante_legal_firmante.domicilio" onFieldChange={handleFieldChange} />
          </div>
        </TabsContent>
      </Tabs>
    );
